<?php 
    ...
    // $jms_select_sql = "SELECT COUNT(*) as count_records FROM `deal-evaluation-calc` WHERE users_id=:jms_user_id";
    // $jms_select_data = $jms_pdo->prepare($jms_select_sql);
    // $jms_select_data->bindParam(':jms_user_id', $jms_user_id, PDO::PARAM_INT);
    // $jms_select_data->execute();
        ...
        if((isset($jms_row[0]['jms_unlimited_deal']) && $jms_row[0]['jms_unlimited_deal'] != "") || (isset($jms_row[0]['jms_no_save_deal']) && $jms_row[0]['jms_no_save_deal'] != 0))
        {
            if(isset($jms_row_cancel[0]['purchase']))
            {
                ...
                // update query 
                    ...
                    if($jms_row_cancel[0]['purchase'] == 'deal-evalution')
                    {
...
<head>
    ...
    <style type="text/css">
        ...
        .input-group.input-group-sm input[type="text"]:focus 
        {
                ...
                <div class="jms-calcutor-section">
                    <div class="row d-flex justify-content-center">
                        ...
                        <div class="col-md-8">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="form-control" id="jms_name" name="jms_name" value="">
                                    </td>
                                </tr>
                                <tr>
                                    <td>Date</td>
                                    <td>
                                        <input type="date" class="form-control w-100" id="jms_date" name="jms_date">
                                    </td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <div class="col-md-8">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="input-group input-group-sm">
                                            <input type="number" class="form-control text-end" id="jms_down_payment_percentage" name="jms_down_payment_percentage">
                                            <span class="input-group-text" id="basic-addon1">%</span>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" class="form-control text-end" id="jms_residential_appraisal" name="jms_residential_appraisal">
                                    </td>
                                </tr>
                                <tr>
                                    <td>Inspection </td>
                                    <td>
                                        <input type="number" class="form-control text-end" id="jms_inspection" name="jms_inspection">
                                    </td>
                                </tr>
                                <tr>
                                    <td>Closing cost</td>
                                    <td class="d-flex w-100 justify-content-between align-items-center">
                                        <div class="input-group input-group-sm w-50">
                                            <input type="number" class="form-control text-end" id="jms_closing_percentage" name="jms_closing_percentage" value="5">
                                            <span class="input-group-text" id="basic-addon1">%</span>
                                        </div>
                        ...
                        <div class="col-md-8">
                            <table class="table table-hover jms-table-mortgage">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="input-group input-group-sm">
                                            <input type="number" class="form-control text-end" id="jms_annual_interest_rate" name="jms_annual_interest_rate">
                                            <span class="input-group-text" id="basic-addon1">%</span>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" class="form-control text-end" id="jms_number_of_years" name="jms_number_of_years">
                                    </td>
                                </tr>
                                <tr>
                        ...
                        <div class="col-md-8">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="input-group input-group-sm">
                                            <input type="number" class="form-control text-end" id="jms_card_annual_apr" name="jms_card_annual_apr">
                                            <span class="input-group-text" id="basic-addon1">%</span>
                                        </div>
                                    </td>
                                </tr>
                        ...
                        <div class="col-md-8 jms-table-property-expenses-col">
                            <table class="table table-hover jms-table-property-expenses">
                                <thead>
                                    <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="input-group input-group-sm">
                                            <span class="input-group-text" id="basic-addon1">$</span>
                                            <input type="text" class="form-control text-end" id="jms_repairs_annually"
                                                name="jms_repairs_annually">
                                        </div>
                                    </td>
                                </tr>
                                <!-- <tr>
                            ...
                            <table class="table table-hover">
                                <tr>
                                    ...
                                    <td>
                                        <div class="input-group input-group-sm">
                                            <span class="input-group-text" id="basic-addon1">$</span>
                                            <input type="text" class="form-control text-end" id="jms_home_owners_insurance" name="jms_home_owners_insurance">
                                        </div>
                                    </td>
                                </tr>
                                <!-- <tr>
                        ...
                        <div class="col-md-8">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    <td>Total Units</td>
                                    <td>
                                        <input type="number" class="form-control text-end" id="jms_total_units" name="jms_total_units">
                                    </td>
                                </tr>
                                <tr>
                                    <td>Rent per unit</td>
                            ...
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="input-group input-group-sm">
                                            <span class="input-group-text" id="basic-addon1">$</span>
                                            <input type="text" class="form-control text-end" id="jms_new_property_appraisal_price" name="jms_new_property_appraisal_price">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="input-group input-group-sm">
                                            <input type="number" class="form-control text-end" id="jms_ltv_ratio_percentage" name="jms_ltv_ratio_percentage">
                                            <span class="input-group-text" id="basic-addon1">%</span>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="input-group input-group-sm">
                                            <input type="number" class="form-control text-end" id="jms_mortgage_annual_interest_rate" name="jms_mortgage_annual_interest_rate">
                                            <span class="input-group-text" id="basic-addon1">%</span>
                                        </div>
                                ...
                                <tr>
                                    <td>Number of Years</td>
                                    <td>
                                        <input type="number" class="form-control text-end" id="jms_mortgage_number_of_years" name="jms_mortgage_number_of_years">
                                        <!-- <div class="text-end" id="jms_mortgage_number_of_years"></div> -->
                                    </td>
                                </tr>
                                <tr>
                                    <td>New Mortgage Note Yearly</td>
                                    <td>
                                        <div class="text-end" id="jms_mortgage_yearly_payment"></div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>New Morgage Note Monthly</td>
                                    <td>
                                        <div class="text-end" id="jms_mortgage_monthly_payment"></div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>New Morgage Note Daily</td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td class="d-flex w-100 justify-content-between align-items-center">
                                        <div class="input-group input-group-sm w-50">
                                            <input type="number" class="form-control text-end" id="jms_closing_cost_per" name="jms_closing_cost_per">
                                            <span class="input-group-text" id="basic-addon1">%</span>
                                        </div>
                                ...
                                <tr>
                                    <td>Original Mortgage Note</td>
                                    <td>
                                        <div class="text-end" id="jms_original_mortgage_note"></div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Carrying cost</td>
                        ...
                        <div class="col-md-12 d-flex justify-content-center">
                            <div class="row">
                                ...
                                <div class="col-md-12 d-flex justify-content-center">
                                    <button class="jms-form-submit" id="jms_deal_evaluation_save_btn" name="jms_deal_evaluation_save_btn">Save</button>
                                </div>
                            </div>
                        </div>
                    </div>
