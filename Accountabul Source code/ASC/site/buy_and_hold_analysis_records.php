<?php 
    ...
    $jms_select_sql = "SELECT * FROM `buy-and-hold-analysis-calc` WHERE users_id=:jms_user_id AND calc_data_records != ''";
                ...
                $.ajax({
                    ...
                    success: function(result){
                        if(result.trim() == "success")
                        {
                            ...
                            window.location = 'buy_and_hold_analysis_records.php';
                        }
                        else
                        {
